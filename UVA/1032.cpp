...
pll mem[35][3];
bool visited[35][3];
pll GO(int pos, bool issmall, int prev)
{
    ...
    ll first = zero.first + one.first;
    ll second = prev*one.first + zero.second + one.second;
    pll ans = pll(first, second);
