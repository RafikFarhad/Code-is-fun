...
#ifndef ONLINE_JUDGE
    freopen("12554.inp","r",stdin);
#endif
    ///                                    MAIN
    char line[16][10] = {"Happy", "birthday", "to", "you", "Happy", "birthday", "to", "you", "Happy", "birthday", "to", "Rujia", "Happy", "birthday", "to", "you"};
    int i, j, n, t, guest[105][105], bar, temp;
    sf("%d ", &n);
    for(i=0; i<n; i++)
        sf("%s", guest[i]);
