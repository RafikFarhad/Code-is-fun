...
int main()
{
   ...
   // freopen("000.txt","r",stdin);
...
#endif
    ///                                    MAIN
    int i, t, j, k, l,  keis=0, a, b, c, d, x, y, ar[205], n, res;;
    ...
    while(t--)
    {
        ...
        {
            if(it->first.xx>=x)
                a++;//deb(it->first.xx, it->first.yy, it->second);
        }
        csi;
        _(a);
